...
```hcl
module "backend" {
  source = "github.com/sequring/terraform-aws-bootstrap"
...
Terraform might ask you if you want to copy your existing state. 
...
The variable use aim to AWS region for bootsrap
...
https://github.com/sequring/terraform-aws-bootsrap/blob/main/variables.tf
